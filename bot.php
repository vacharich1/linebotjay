					...
					if($textcut[0]=="@g")
					{
						...
						if(preg_match("/^[a-zA-Z0-9.]+$/", $textcut[2]) == 1)
						{
							...
							if($check_day_time=="1")
							{
								...
								$messages556 = ['type' => 'text','text' => "coming soon..."];
								$url = 'https://api.line.me/v2/bot/message/reply';
								$data = [
											'replyToken' => $replyToken,
											'messages' => [$messages556]

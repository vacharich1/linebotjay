...
// Loop through each event
	...
	foreach ($events['events'] as $event) {
		if($event['source']['userId'] == 'Ub5f45b12f0f8f8a3a08e5b52ebbcc96b' || $event['source']['groupId'] =='Cc5000f2d47fa9df8096c866a6f4402e9' || $event['source']['groupId'] =='C85404b458e7caaa96629fa66941c9d93' || $event['source']['groupId'] =='C0773ad778af7cec264763eb058303c53')
		{
				...
				if($result <= 2)
				{
						...
						if($arr1[0] == "@")
						{
							...
							else
							{
								...
								sleep(0.1);
								if($timeframe !="assets" and $timeframe !="libilities" and $timeframe !="equity" and $timeframe !="revenue" and $timeframe !="eps"and $timeframe !="expenses" and $timeframe !="gprofit" and $timeframe !="gmargin" and $timeframe !="nprofit" and $timeframe !="nmp" and $timeframe !="as" and $timeframe !="lb" and $timeframe !="eq" and $timeframe !="rv" and $timeframe !="ex" and $timeframe !="gp" and $timeframe !="gm" and $timeframe !="np" )
								{
									$messages3 = ['type' => 'text','text' => "คำสั่งทั้งหมด @hoon assets/as       @hoon libilities/lb        @hoon equity/eq        @hoon revenue/rv       @hoon eps     @hoon expenses/ex       @hoon gprofit/gp        @hoon gmargin/gm        @hoon nprofit/np         @hoon nmp       EX @hoon assert/as ----> @aot assets or @aot as"];
